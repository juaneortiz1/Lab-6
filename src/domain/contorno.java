 ...
 * una capa al rededor de las celulas que titilan 
 * @author: Sergio Gonzales - Juan Esteban Ortiz
 * @version: 10/10/2022
 */
public class contorno extends Cell{
    private int row,column;
    private AManufacturing am;
    boolean active;
    public contorno(AManufacturing am,int row, int column, boolean active)
    {
    ...
    /**
     * decide for objects of class contorno
     */
    @Override
    public void decide(){
        if(active){
